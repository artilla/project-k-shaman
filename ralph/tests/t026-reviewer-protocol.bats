#!/usr/bin/env bats
# ralph/tests/t026-reviewer-protocol.bats — T026 acceptance criteria validation
# Verifies ralph/docs/runbook.md contains required reviewer result protocol section.

RUNBOOK="$(cd "$BATS_TEST_DIRNAME/../.." && pwd)/ralph/docs/runbook.md"
