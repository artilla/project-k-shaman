#!/usr/bin/env bash
# ralph/scripts/check_scope_omission.sh — ADR-0014 §4 사례 1: acceptance criteria 산출물 vs changed-files 대조
#
# 사용법:
#   ./ralph/scripts/check_scope_omission.sh <ticket-path> [--base <branch>] [--changed-files <file>]
#
