#!/usr/bin/env bash
# ralph/scripts/mission_control.sh — Mission Control 서버 시작/중지 래퍼
# ADR-0024: localhost 전용, 상태 비보유, 외부 의존성 0
#
# 사용법:
#   ./ralph/scripts/mission_control.sh start [--port <n>] [--private-path <iface>]
...
SERVER="$ROOT/ralph/mission-control/server.mjs"
