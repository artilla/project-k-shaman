...
| --- | --- | --- | --- |
| 점신 | 종합 운세 앱(오늘 운세·사주·타로·상담) | 콘텐츠 폭, 인지도 | 광고 피로, 앱 중심 UX |
| 포스텔러 | 운세 점수·캘린더·길일·사주/타로/궁합 | 실용형 의사결정 운세 | 캐릭터 음성 퍼포먼스 약함 |
| 헬로우봇/라마마 | 사주·타로·AI 채팅·챗봇 캐릭터·구독 | 대화형·캐릭터 친밀감 | 무대형 시청각·영상 공유 약함 |
| 기리고 | 소원을 영상으로 기록·저장 | 의례적 감성 UX | 매일 반복 리텐션 약함 |
| 오늘신당 | AI 무당이 움직이고 말하는 오늘의 운세 | 음성·모션·팬덤·공유 카드/영상 | 원가 구조·콘텐츠 품질 관리가 핵심 리스크 |

> 포지셔닝: 점신/포스텔러가 "운세 정보 플랫폼", 헬로우봇이 "운세 챗봇"이라면, 오늘신당은 "매일 1분짜리 캐릭터 운세 공연"이다.
