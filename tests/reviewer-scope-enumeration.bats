#!/usr/bin/env bats
# tests/reviewer-scope-enumeration.bats — T032 acceptance criteria validation
# Static verification that skills/reviewer.md contains required format specifications.
# Does NOT call the reviewer persona; validates the spec document itself.

REVIEWER_SKILL="$(cd "$BATS_TEST_DIRNAME/.." && pwd)/skills/reviewer.md"
