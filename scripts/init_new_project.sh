...
#
# 철학: 이식 가능한 하네스(scripts·skills·tests·TEMPLATE·runbook·.gitignore)만 복사하고,
#       Hephaestus 고유 누적물(ADR·DONE 티켓·PDF·보고서·기존 master-spec)은 가져오지 않는다.
...
SKELETON_DIRS=(
  ...
  "state" "state/reservations" ".ralph/logs"
)
