#!/usr/bin/env bash
# scripts/lib/base_branch.sh — BASE_BRANCH 자동 검출 라이브러리
#
# Usage (source):
#   source "$ROOT/scripts/lib/base_branch.sh"
...
# Direct execution support: BASE_BRANCH=$(./scripts/lib/base_branch.sh)
