...
SCHEMA_PATH = _HERE / "fortune-schema.v1.1.json"
SAMPLES_PATH = _HERE / "fortune-samples.v1.1.json"


def validate_samples(schema_path: Path = SCHEMA_PATH, samples_path: Path = SAMPLES_PATH) -> int:
