    ...
    <section className="screen">
      ...
      {privacyOpen && (
        <p className="privacy-detail-text">
          닉네임은 서버로 전송되지 않고 이 기기에만 저장됩니다. 생년월일·출생시간은 운세를
          만드는 순간에만 서버로 전달되고, 서버에 저장되지 않으며 즉시 해시값으로 변환돼
          사용됩니다. 전송은 주소창(URL)이 아닌 보호된 요청 본문으로만 이뤄지고, 원본
          생년월일·출생시간은 화면이나 공유 카드 어디에도 다시 표시되지 않습니다.
        </p>
      )}
