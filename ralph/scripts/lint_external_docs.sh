#!/usr/bin/env bash
# ralph/scripts/lint_external_docs.sh — 외부 공개 산출물 lint (ADR-0014 §4 사례 2·3)
#
...
#
# 사용법:
#   ./ralph/scripts/lint_external_docs.sh               # 기본: docs/onboarding docs/decisions
#   LINT_EXTERNAL_TARGET=docs/other ./ralph/scripts/lint_external_docs.sh
#   LINT_EXTERNAL_TARGET="path1 path2" ./ralph/scripts/lint_external_docs.sh
#
# exit 0: 위반 없음 (게이트 통과)
