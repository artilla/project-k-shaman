#!/usr/bin/env bats
# tests/t056-timeout-wip-guidance.bats — T056 acceptance criteria validation.
# Verifies run_headless.sh default timeout and orchestrator.sh WIP guidance text.

REPO_ROOT="$(cd "$BATS_TEST_DIRNAME/.." && pwd)"
RUN_HEADLESS="$REPO_ROOT/scripts/run_headless.sh"
ORCHESTRATOR="$REPO_ROOT/scripts/orchestrator.sh"
